...
import YMoneyForm from "../YMoneyForm"
...
const App = () => {
	return (
		<>
			...
			<br />
			<Card
				image={require("../../img/ymoney.png").default}
				title={<span>Через ЮMoney или Яндекс.Деньги <img alt="wallet" className={styles.inlineImage} src={require("../../img/wallet.svg").default} /></span>}
				className={styles.kaspi}
			>
				<YMoneyForm />
			</Card>
